...
@Component({
  selector: 'app-incentive-to-bank',
  templateUrl: './incentive-to-bank.component.html',
  styleUrls: ['./incentive-to-bank.component.css']
})
export class IncentiveToBankComponent implements OnInit {
